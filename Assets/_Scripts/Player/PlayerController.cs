...
public class PlayerController : MonoBehaviour
{
    ...
    //No puede tener Update sino va a estar corriendo en simultáneo con el battleManager 
    public void HandleUpdate()
    {
        if (!isMoving)
        {
            ...
            if(input != Vector2.zero)
            {
                ...
                //Ejecuto la corrutina si el camino est� disponible
    ...
    //Se ejecuta despu�s de todos los updates, es el "ultimo" 
    ...
    {
        //Verifica que el camino est� disponible para dirigirse y prender la corrutina
